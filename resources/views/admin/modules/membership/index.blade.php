@section('meta')
<title>{{ config('app.name') }} | {{ __('Memberships') }}</title>
@endsection
...
<x-adminLayout>
    ...
    <div class="{{ $cssNs }}">
        ...
        @include('admin.layouts.breadcrumb', [
            ...
            'description' => __('Membership Introduction'),
            'breadcrum' => [
                __('Memberships') => '#',
            ],
        ])
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            @can('modules.membership.add')

                                <div class="col-md-12 d-flex justify-content-end mb-4">

                                    <a href="{{ route('membership.create') }}" class="btn btn-primary">{{ __('Membership') }} {{ strtolower(__('Add')) }}</a>
