@section('meta')
<title>{{ config('app.name') }} | {{ __('Games') }}</title>
@endsection
...
<x-adminLayout>
    ...
    <div class="{{ $cssNs }}">
        ...
        @include('admin.layouts.breadcrumb', [
            'title' => __('Games'),
            'description' => __('Game Introduction'),
            'breadcrum' => [
                __('Games') => '#',
            ],
        ])
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            @can('modules.game.add')

                                <div class="col-md-12 d-flex justify-content-end mb-4">

                                    <a href="{{ route('game.create') }}" class="btn btn-primary">{{ __('Game') }} {{ strtolower(__('Add')) }}</a>
