@section('meta')
<title>{{ config('app.name') }} | {{ __('Seasons') }}</title>
@endsection
...
<x-adminLayout>
    ...
    <div class="{{ $cssNs }}">
        ...
        @include('admin.layouts.breadcrumb', [
            'title' => __('Seasons'),
            'description' => __('Season Introduction'),
            'breadcrum' => [
                __('Seasons') => '#',
            ],
        ])
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            @can('modules.season.add')

                                <div class="col-md-12 d-flex justify-content-end mb-4">

                                    <a href="{{ route('season.create') }}" class="btn btn-primary">{{ __('Season') }} {{ strtolower(__('Add')) }}</a>
