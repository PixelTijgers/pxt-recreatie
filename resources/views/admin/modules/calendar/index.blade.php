@section('meta')
<title>{{ config('app.name') }} | {{ __('Calendars') }}</title>
@endsection
...
<x-adminLayout>
    ...
    <div class="{{ $cssNs }}">
        ...
        @include('admin.layouts.breadcrumb', [
            'title' => __('Calendars'),
            'description' => __('Calendars Introduction'),
            'breadcrum' => [
                __('Calendars') => '#',
            ],
        ])
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            @can('modules.calendar.add')

                                <div class="col-md-12 d-flex justify-content-end mb-4">

                                    <a href="{{ route('calendar.create') }}" class="btn btn-primary">{{ __('Calendar') }} {{ strtolower(__('Add')) }}</a>
