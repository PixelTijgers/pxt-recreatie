@section('meta')
<title>{{ config('app.name') }} | {{ __('Board') }}</title>
@endsection
...
<x-adminLayout>
    ...
    <div class="{{ $cssNs }}">
        ...
        @include('admin.layouts.breadcrumb', [
            'title' => __('Board'),
            'description' => __('Board Introduction'),
            'breadcrum' => [
                __('Board') => '#',
            ],
        ])
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            @can('modules.board.add')

                                <div class="col-md-12 d-flex justify-content-end mb-4">

                                    <a href="{{ route('board.create') }}" class="btn btn-primary">{{ __('Boardmember') }} {{ strtolower(__('Add')) }}</a>
