@section('meta')
<title>{{ config('app.name') }} | {{ __('Teams') }}</title>
@endsection
...
<x-adminLayout>
    ...
    <div class="{{ $cssNs }}">
        ...
        @include('admin.layouts.breadcrumb', [
            'title' => __('Teams'),
            'description' => __('Team Introduction'),
            'breadcrum' => [
                __('Teams') => '#',
            ],
        ])
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            @can('modules.team.add')

                                <div class="col-md-12 d-flex justify-content-end mb-4">

                                    <a href="{{ route('team.create') }}" class="btn btn-primary">{{ __('Team') }} {{ strtolower(__('Add')) }}</a>
