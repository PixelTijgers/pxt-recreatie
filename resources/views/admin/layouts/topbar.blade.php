    ...
    <div class="navbar-content">
        ...
        <ul class="navbar-nav">
            ...
            <li class="nav-item dropdown">
                ...
                @php
                    $getSeasons = \App\Models\Season::where('year', session()->get('season'))->first('name')
                @endphp
                ...
                <a class="nav-link dropdown-toggle" href="#" id="seasonDropdown" role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    <span class="ms-1 me-1 d-none d-md-inline-block">{{ $getSeasons->name }}</span>
                </a>

                <div class="dropdown-menu" aria-labelledby="seasonDropdown">

                    @foreach(\App\Models\Season::orderBy('year', 'DESC')->limit(5)->get() as $seasons => $season)

                        <a href="{{ route('change.season', $season->year) }}" class="dropdown-item py-2"><span class="ms-1">{{ $season->name }}</span></a>
